  ...
  EkkoLightbox.prototype = {
    modal_shown: function () {
      ...
      if (!this.options.remote) {
        ...
        if (this.gallery) {
          if (
            this.options.gallery_parent_selector === "document.body" ||
            this.options.gallery_parent_selector === ""
          ) {
            this.gallery_items = $(document.body).find(
    ...
    showLoading: function () {
      this.lightbox_body.html(
        '<div class="modal-loading">' + this.options.loadingMessage + "</div>"
      );
      return this;
    },
    showYoutubeVideo: function (id) {
      ...
      if (
        this.$element.attr("data-norelated") != null ||
      ...
      return this.showVideoIframe(
        "//www.youtube.com/embed/" + id + "?badge=0&autoplay=1&html5=1" + rel,
        width,
        height
      );
    },
    ...
    loadRemoteContent: function (url) {
      ...
      disableExternalCheck =
        this.$element.data("disableExternalCheck") || false;
