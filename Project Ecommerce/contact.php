 <div id="contact-page" class="container">
        <div class="bg">
            <div class="row">           
                <div class="col-sm-12">                         
                    <h2 class="title text-center">Liên lạc <strong>với chúng tôi</strong></h2>                                                      
            ...
            <div class="row">   
                <div class="col-sm-8">
                    <div class="contact-form">
                        ...
                        <form id="main-contact-form" class="contact-form row" name="contact-form" method="post">
                            ...
                            <div class="form-group col-md-12">
                                <textarea name="message" id="message" required="required" class="form-control" rows="8" placeholder="Thông điệp của khách hàng"></textarea>
                            </div>                        
                            <div class="form-group col-md-12">
                ...
                <div class="col-sm-4">
                    <div class="contact-info">
                        ...
                        <address>
                            <p>NPIF-Shopper Inc.</p>
                            <p>Ho Chi Minh City, Vietnam</p>
                            <p>Mobile: +2346 17 38 93</p>
                            <p>Email: NPIF@gmail.com</p>
                        </address>
